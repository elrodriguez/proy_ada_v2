<script type="text/javascript" src="_recursos/js/console_documento_coordinador_etapa_seis.js"></script>
...
<div class="modal fade" id="modal_asignar_revisor_documento">
      ...
      <div class="panel-body">
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            <div class="form-group">
              <label>Tipo</label>
              <select id="select-revisor-documento-tipo" class="form-control">
                <option value="I">Independiente</option>
                <option value="C">Comisión</option>
                <option value="D">Docente del Curso</option>
              </select>
            </div>
          </div>
          <div class="col-md-3">
            <div class="form-group">
              ...
              <select id="select-revisor-documento-modalidad" class="form-control">
                <option value="I">Investigador asociado</option>
...
<div class="modal fade" id="myModalComboDrop" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabelComboDrop">Publicación</h4>
      </div>
      <div class="modal-body">
        <form id="formtipopublicacion">
          <input id="tipopublicacioniddociuemneto" type="hidden" name="tipopublicacioniddociuemneto">
        <div class="form-group">
          <label for="tipo">Tipo publicación</label>
          <select class="form-control" name="tipo_publicacion" id="tipo_publicacion" onchange="abririnputadicional()">
            <option value="1">Tradicional</option>
            <option value="2">Articulo no Publicado</option>
            <option value="3">Articulo publicado</option>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
        <button type="button" class="btn btn-primary" onclick="registrartipopublicacion()">Guardar</button>
      </div>
    </div>
  </div>
</div>
