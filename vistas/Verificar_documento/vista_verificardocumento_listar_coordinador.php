...
<div class="contendor_kn">
  <div class="panel panel-default">
    <div class="panel-heading">
        <h4><b>COORDINADOR: CONTROL PROYECTO TESIS</b></h4>
    </div>
...
<!-- INICIO MODAL -->
<script type="text/javascript">listar_verificardocumento_vista_coordinador("PENDIENTE","1");</script>
<!--Fin Modal-->
...
<script type="text/javascript">
  $(document).ready(function(){
    $("#combo_estado_documento").change(function(){
      ...
      listar_verificardocumento_vista_coordinador(dato_Tipo,'1');
    });
  })
</script>
<script>
