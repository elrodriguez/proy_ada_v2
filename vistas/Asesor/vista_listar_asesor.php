...
<div class="contendor_kn">
  <div class="panel panel-default">
    <div class="panel-heading">
        <h2><b>DOCENTES REGISTRADOS</b></h2>
    </div>
    <div class="panel-body">
        ...
        <div class="col-md-12">
            <div class="table-responsive" style="text-align: center;">
            	<br>
            	<label>LISTADO DEL DOCENTES - TODAS LAS CARRERAS</label>
...
<form class="modal fade" tabindex="-1" role="dialog" id="modal_editar_asesor">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		  <div class="row">
	  			<div class="col-sm-4">
					<input type="text" id="txtidciudadano"  name="txtidciudadano" hidden >
					<label>Nombres </label>
				...
				<div class="col-md-4">
					...
					<select id="txtcategoria" class="form-control" name="txtcategoria">
						<option value="tiempo completo">Tiempo Completo</option>
						<option value="parcial">Parcial</option>
						<option value="parcial-recibo">Parcial-Recibo</option>
						<option value="externo">Externo</option>
					</select>
				</div>
				<div class="col-md-8">
					<label>Tipo</label>
					<select id="cboTipo" name="cboTipo[]" multiple="multiple" style="width: 100%" class="form-control select2">
					</select>
				</div>
		  </div>
      </div>
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="editar_asesor()">Actualizar</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</form>
