...
$mysqli = new mysqli("localhost","root","hiworld2018","db_ada");
...
if(mysqli_connect_errno()){
	...
	$pdf->SetFont('Courier','B',15);
		...
		$pdf->Cell(120,10, 'GANANCIA TOTAL POR IMPOTE RECAUDADO',0,1,'C');
			...
			$pdf->Cell(80);
			$pdf->Cell(120,10, 'PROYECTO TESIS REGISTRADOS',0,1,'C');
			$pdf->Ln(20);
	...
	$pdf->Cell(192,6,'TITULO DE TESIS',1,0,'C',1);
	$pdf->Cell(30,6,utf8_decode('ÁREA'),1,1,'C',1);
	$pdf->SetFont('Courier','B',10);
	$cont=0;
