...
<div class="modal fade" id="subir-correciones" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">Subir Correciones</h4>
      </div>
      <div class="modal-body">
        
        <form enctype="multipart/form-data" id="form-upload-file-anexos">
          <div class="form-group">
              <label for="file-ax1">V1</label>
              ...
              <input type="hidden" id="iddocumentovcorrecciones">
            </div>
            <div class="form-group">
              <label for="file-pc">V2</label>
              <div class="input-group">
