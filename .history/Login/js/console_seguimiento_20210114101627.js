			...
			for (var i = 0; i < valores.length; i++) {
				cadena += "<tr>";			
					...
					if(valores[i]['num_proceso'] == '6'){
						btn_subir_1_etapa6 = `<button type="button" class="btn btn-primary" name="`+valores[i][0]+`*`+valores[i]['anexo_uno_etapa_cuatro']+`" onclick="modalsubircorrecionesetapacuatro(this,'9')">
												<i class="glyphicon glyphicon-open"></i>
											  </button>`;
						btn_subir_2_etapa6 = `<button type="button" class="btn btn-primary" name="`+valores[i][0]+`*`+valores[i]['carta_etapa_cuatro']+`" onclick="modalsubircorrecionesetapacuatro(this,'10')">
												<i class="glyphicon glyphicon-open"></i>
					  						</button>`;
					}else{
						btn_subir_1_etapa6 = '';
