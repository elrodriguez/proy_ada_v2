			...
			for (var i = 0; i < valores.length; i++) {
				cadena += "<tr>";			
					...
					if(valores[i]['num_proceso'] == '7' && valores[i]['doc_estado'] == 'RECHAZADO'){
						btn_ver_1_etapa7 = `<a target="_blank" href="../`+datos_split['anexo_dies']+`" class='btn btn-primary btn-sx' style='background-color:#fff;border-color:#fff' title='Ver documento Cargado'><i class='fa  fa-folder-open' style='color:orange;'></i></a>`;
