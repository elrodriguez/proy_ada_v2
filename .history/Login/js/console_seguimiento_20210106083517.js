			...
			for (var i = 0; i < valores.length; i++) {
				cadena += "<tr>";			
					...
					if(valores[i]['anexo_seis']!="null" && valores[i]['anexo_seis_2']=='null' && valores[i]['anexo_seis_3']== 'null'){
						btn_a6 = `<a class='btn btn-primary' href="`+valores[i]['anexo_seis']+`"><i class='glyphicon glyphicon-upload'></i></button>`;
					}else if(valores[i]['anexo_seis_2']!='null' && valores[i]['anexo_seis_3']== 'null'){
						btn_a6 = `<a class='btn btn-primary' href="`+valores[i]['anexo_seis_2']+`"><i class='glyphicon glyphicon-upload'></i></button>`;
					}else if(valores[i]['anexo_seis_3']!= 'null'){
						btn_a6 = `<a class='btn btn-primary' href="`+valores[i]['anexo_seis_3']+`"><i class='glyphicon glyphicon-upload'></i></button>`;
					}
