      ...
      <br>
		...
		<div class="right-form-agile">
			<div class="sub-main-w3">
				...
				<a href="seguimiento.php" class="btn btn-default" style="box-shadow: 0 0 0 .2rem rgba(0,0,0,0);font-size: 20px; font-weight:bold">Seguimiento Documentario</a><br><br>
