				...
				<div class="input-group mb-12 col-md-12">
					<table id="tabla_horario" class="table table-bordered jambo_table">
                        ...
                        <tr>
                          ...
                          <th colspan="3" style = 'text-align: center;color: #fff;width: 80px;word-wrap: break-word;font-weight: bold;'> Etapa 4 </th>
                          ...
                          <th colspan="3" style = 'text-align: center;color: #fff;width: 80px;word-wrap: break-word;font-weight: bold;'> Etapa 9 </th>
                          <th rowspan="2" style = 'vertical-align: middle;text-align: center;color: #fff;width: 30px;word-wrap: break-word;font-weight: bold;'>ESTADO</th>
                            ...
                            <th style = 'text-align: center;color: #fff;width: 30px;word-wrap: break-word;font-weight: bold;'>A1</th>
                            <th style = 'text-align: center;color: #fff;width: 30px;word-wrap: break-word;font-weight: bold;'>Carta</th>
                            <th style = 'text-align: center;color: #fff;width: 30px;word-wrap: break-word;font-weight: bold;'>A7</th>
                            <th style = 'text-align: center;color: #fff;width: 30px;word-wrap: break-word;font-weight: bold;'>A8</th>
                            <th style = 'text-align: center;color: #fff;width: 30px;word-wrap: break-word;font-weight: bold;'>ARCHIVO</th>
                            ...
                            <th style = 'text-align: center;color: #fff;width: 30px;word-wrap: break-word;font-weight: bold;'>Correccion</th>
		                    </tr>
		                </thead>
...
<div class="modal fade" id="subir-correciones-etapa-cuatro" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Subir Correciones</h4>
      ...
      <div class="modal-body">
        ...
        <form enctype="multipart/form-data" id="form-upload-file-anexos-corregidos-etapa-cuatro">
          <div class="form-group">
              ...
              <div class="input-group">
                <input type="file" class="form-control" id="file-ax1-e4" name="file-ax1-e4">
                <span class="input-group-btn" id="btnverax1e4"></span>
              </div>
              <input type="hidden" id="iddocumentovcorreccionescuatro" name="iddocumentovcorreccionescuatro">
              <input type="hidden" id="tipo-e4" name="tipo-e4">
            </div>
        </form>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">cerrar</button>
        <button type="button" class="btn btn-primary" onclick="registrar_documento_anexos_corregidos_etapa_cuatro()">subir</button>
      </div>
    </div>
  </div>
</div>
