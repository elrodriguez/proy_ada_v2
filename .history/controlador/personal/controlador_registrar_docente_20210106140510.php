<?php
	...
	$estado  = $_POST["cmb_estadopersonal"];
	...
	$consulta = $MC->registrar_docente($nombre,$apePat,$apeMat,$telefo,$movil,$direcc,$fecnac,$dni,$email,$genero,$estado,$tipos,$txtcategoria);
	echo $consulta;
?>