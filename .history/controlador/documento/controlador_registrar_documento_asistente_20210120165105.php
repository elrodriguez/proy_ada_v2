<?php
	...
	$consulta = $MC->Registrar_documento_asistente($extension,$asunto,$idnumero,$idtipodocu,$idasesores,$idarea,$idremitentes,$idusuario,$opcion,null,$cont,$modalidad);
	...
	if ($_FILES["id_archivo"]['tmp_name']!="") {
		...
		$destino1 = $dir.$imagen;
		$destinoImagen = $destino_carpeta.$iddocumento.'/'.$imagen;
		//print_r($ruta1);exit;
		copy($ruta1, $destino1);
		$cont=1;
