<?php
    ...
    try {
        ...
        $mail->Host       = 'smtp.proyada.local';                     //Set the SMTP server to send through
        $mail->SMTPAuth   = true;                                   //Enable SMTP authentication
        $mail->Username   = 'elrodriguez2423@example.com';                     //SMTP username
        $mail->Password   = 'S3r4t02020';                           //SMTP password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;         //Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
        $mail->Port       = 587;                                    //TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above

        //Recipients
        $mail->setFrom('elrodriguez2423@example.com', 'Mailer');
        $mail->addAddress('rb.elmer@hotmail.com', 'Elmer Luis');     //Add a recipient
