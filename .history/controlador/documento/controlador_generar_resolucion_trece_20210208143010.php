<?php
    ...
    //  header('Content-Type: text/html; charset=utf-8');  
     ...
     foreach($jurados as $jurado){
         echo "<tr >";
         if($cc == 0){
            echo "<td style='border: 1px solid #000;'><b>Presidente</b></td>";
         }else{
            echo "<td style='border: 1px solid #000;'><b>Miembro ".$cc."</b></td>";
         }
         
         echo "<td style='border: 1px solid #000;'>".$jurado['full_name']."</td>";
         echo "</tr>";
         $cc++;
    }
    echo "</tbody></table>";
