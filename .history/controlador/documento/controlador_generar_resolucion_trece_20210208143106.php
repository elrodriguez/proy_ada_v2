<?php
    ...
    //  header('Content-Type: text/html; charset=utf-8');  
     ...
     foreach($jurados as $jurado){
         ...
         echo "<td style='border: 1px solid #000;padding:5px;'>".$jurado['full_name']."</td>";
         echo "</tr>";
         $cc++;
    }
    echo "</tbody></table>";
     ...
     echo "<tr><td style='border: 1px solid #000;padding:5px;'>Aprobado</td><td style='border: 1px solid #000;'>(    )</td></tr>";
     echo "<tr><td style='border: 1px solid #000;padding:5px;'>Aprobado - Muy buena</td><td style='border: 1px solid #000;'>(    )</td></tr>";
     echo "<tr><td style='border: 1px solid #000;padding:5px;'>Aprobado - Sobresaliente</td><td style='border: 1px solid #000;'>(    )</td></tr>";
     echo "<tr><td style='border: 1px solid #000;padding:5px;'>Desaprobado</td><td style='border: 1px solid #000;'>(    )</td></tr>";
     echo "</tbody></table>";
