<?php
    ...
    if($consulta['porcentaje'] >=12){
        ...
        $html = `<html>
                    ...
                    <body>
                        <strong>Estimado(a),</strong>
                        #Nombre de autor# (#número de ticket#)

                        Buen día. Me comunicó con usted para informarle que luego de la evaluación de su proyecto titulado “#título del proyecto de tesis#”, a través del sistema Turnitin, el porcentaje encontrado ha excedido el punto de corte que consideramos aceptable (#porcentaje#) por lo que no podemos registrarlo. Le pido que corrija los textos que son observados, los cuales son similares con fuentes externas (mediante el parafraseo, la colocación de comillas o, mejor, resumiendo los párrafos y escribiéndolos de acuerdo con sus propias palabras).
                        ...
                        Luego, vaya a la última parte del texto y encontrará las fuentes en detalle además de algunos comentarios míos. Las correcciones tienen que ser hechas sobre todo en los lugares en donde figuran mis comentarios.

                        Podrá enviarnos la nueva versión corregida, siguiendo el mismo procedimiento que realizó inicialmente. Se cierra ticket.

                        Saludos cordiales, 

                        Francis Tupa Andrade
