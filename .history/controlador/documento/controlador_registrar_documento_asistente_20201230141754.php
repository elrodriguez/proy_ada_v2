<?php
	...
	$idasesores = '';
	foreach($inputs as $key => $input){
		$idasesores.=$input.($key<count($inputs)-1?'*':'');
	}
	//print_r('222222');exit;
	require '../../modelo/modelo_documento_asistente.php';
	$MC = new Modelo_documento();
	$consulta = $MC->Registrar_documento_asistente($iddocumento,$asunto,$idnumero,$idtipodocu,$idasesor,$idarea,$idremitentes,$idusuario,$opcion,$destinoImagen,$cont,$modalidad);
	echo $consulta;
?>
