<?php
	...
	$consulta = $MC->Registrar_documento_asistente(null,$asunto,$idnumero,$idtipodocu,$idasesores,$idarea,$idremitentes,$idusuario,$opcion,$destinoImagen,$cont,$modalidad);
