<?php
    ...
    echo "</tbody></table>";
     ...
     echo "<td style='border: 1px solid #000;'>Aprobado</td><td style='border: 1px solid #000;'>(    )</td>";
     echo "<td style='border: 1px solid #000;'>Aprobado - Muy buena</td><td style='border: 1px solid #000;'>(    )</td>";
     echo "<td style='border: 1px solid #000;'>Aprobado - Sobresaliente</td><td style='border: 1px solid #000;'>(    )</td>";
     echo "<td style='border: 1px solid #000;'>Desaprobado</td><td style='border: 1px solid #000;'>(    )</td>";
     echo "</tbody></table>";
     echo "<p style='text-align: justify;'>Calificándola con nota de: _______ en letras ( ___________________________________)</p>";
     echo "<p style='border: 1px solid #000;'>En fe de lo actuado los miembros de Jurado suscriben la presente Acta en señal de conformidad.</p>";
     echo "</body>";
     echo "</html>";
?>