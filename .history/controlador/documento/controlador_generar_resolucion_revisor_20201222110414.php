<?php
    ...
    header("Content-type: application/vnd.ms-word");
     ...
     echo "<body>";
     echo "<h3>ACEPTAC&Iacute;ON DEL PROYECTO DE TESIS Y NOMBRAMIENTO DEL ASESOR DE TESIS</h3>";
     echo "<p><strong>RESOLUCION DIRECTORIAL DE CARRERA N&deg;XXXXX-CI-DAFCE-U.CIENTIFICA-2020</strong></p>";
