<?php
    ...
    print_r($consulta);exit;
     ...
     }else if($consulta[0]['grado']=='POSGRADO'){
     ...
     echo "<p>Aprobar e inscribir el pryecto de tesis titulado: hhhhhhh y estableser</p>";
     echo "<p>el inicio del periodo de ejecuc&iacute;on de mencionado proyecto.</p>";
     echo "<p>Nombrar al docente jjjjjjjjj como asesor para el desarrollo de tesis en cuestion</p>";
