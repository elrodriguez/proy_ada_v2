<?php
    ...
    echo "</p>";
    echo "<p style='text-align: justify;'><u>Presente. -</u></p>";
    echo "<p style='text-align: justify;'>De mi consideración, </p>";
    ...
    echo "<p style='text-align: center;'>".$consulta[0]['doc_Asunto']."</p>";
    echo "</div>";
    echo "</body>";
    echo "</html>";
?>