<?php
    ...
    foreach($ciudadanos as $ciudadano){
        echo $ciudadano['nombre_completo'].($cui< ($cu-1)?', ': ' y ');
        $cui++;
    }
    echo ", para optar el Título Profesional/grado académico de XXXXXXXXX.</p>";
    ...
    foreach($jurados as $h => $jurado){
            if($ci <=2){
                echo "<td style='text-align: center;'><br><br><p>__________________________________</p><p>".($h == 0?' Presidente del Jurado':'Miembro del Jurado')."</p><p>Lic./Mg./Dr. ".$jurado['full_name']."</p></td>";
                if($ci == 2){
                    echo "</tr>";
                    echo "<tr>";
                    $ci = 0;
    ...
    if($pp%2==0){
        echo "<td colspan='2' style='text-align: center;'><br><br><p>__________________________________</p><p>Asesor</p><p>Lic./Mg./Dr. ".$revisores[0]['full_name']."</p></td>";
    }else{
        echo "<td style='text-align: center;'><br><br><p>__________________________________</p><p>Asesor</p><p>Lic./Mg./Dr. ".$revisores[0]['full_name']."</p></td>";
    }
    echo "</tr>";
