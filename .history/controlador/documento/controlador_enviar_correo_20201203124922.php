    ...
    if($consulta['porcentaje'] >=12){
        ...
        $message = `<html>
                    ...
                    <body>
                        ...
                        <p>#Autor_principal# (`.$consulta[0]['doc_ticket'].`)</p>
                        <p>Presente. –</p>
        ...
        $message = `<html>
                    ...
                    <body>
                        <strong>Estimado(a),</strong>
                        <p>#Nombre de autor# (`.$consulta['doc_ticket'].`)</p>

                        <p>Buen día. Me comunicó con usted para informarle que luego de la evaluación de su proyecto titulado “`.$consulta['doc_asunto'].`”, a través del sistema Turnitin, el porcentaje encontrado ha excedido el punto de corte que consideramos aceptable (`.$consulta['porcentaje'].`) por lo que no podemos registrarlo. Le pido que corrija los textos que son observados, los cuales son similares con fuentes externas (mediante el parafraseo, la colocación de comillas o, mejor, resumiendo los párrafos y escribiéndolos de acuerdo con sus propias palabras).</p>
