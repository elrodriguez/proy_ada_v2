<?php
    ...
    if($pp%2==0){
        echo "<td colspan='2'><p>_______________________________</p><p>Asesor</p><p>Lic./Mg./Dr. ".$revisores[0]['full_name']."</p></td>";
    }else{
        echo "<td><p>_______________________________</p><p>Asesor</p><p>Lic./Mg./Dr. ".$revisores[0]['full_name']."</p></td>";
    }
    echo "</tr>";
