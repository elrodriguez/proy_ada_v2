<?php
    ...
    print_r($consulta);exit;
     ...
     echo "<p style='text-align: justify;'>El informe de resoluíon independiente académico y la aprobacíon de un comité de Ética del proyecto de tesis tulado: ".$consulta." presentado por: GIANELLA MELANIE SUARES PITMMAN</p>";
