...
<div class="contendor_kn">
  <div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="col-md-2">
          <button class="btn btn-danger" onclick="cargar_contenido('main-content','Documento/vista_documento_registrar_asistente.php');"><i class="fa fa-file-text" ></i> &nbsp;&nbsp;<strong>Nuevo Registro</strong></button>
        </div>
        <div class="col-md-12">
...
<!-- MODAL ACTUALIZAR ARCHIVO ______-INICIO -->
<div class="modal fade" tabindex="-1" role="dialog" id="modal-ver-turniting">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <iframe id="iframemodalturniting" src="http://proyada.test/controlador/documento/Archivo/5fc8fe4bac515-123.pdf" width="100%" height="500" frameborder="0" scrolling="no"></iframe>
      </div>
      <div class="modal-footer">
...
<div class="modal" tabindex="-1" id="modal-subir-turning">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
...
<div class="modal fade bs-example-modal-lg" id="modal_editar_personal">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <div class="modal-footer">
        	<button  class="btn btn-success" onclick="Editar_personal()"><i class="fa fa-check"></i>&nbsp;<b>Modificar Documento</b></button>&nbsp;&nbsp;&nbsp;
            <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fa fa-close"></i>&nbsp;<b>Cancelar</b></button>
        </div>
    </div>
  </div>
</div>
<!-- MODAL ACTUALIZAR ARCHIVO ______-FINAL -->
