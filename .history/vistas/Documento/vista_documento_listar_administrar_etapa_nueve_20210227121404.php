...
<div class="modal" tabindex="-1" id="modal-repositorio">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Registrar Repositorio</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
      <form enctype="multipart/form-data" id="form-register-repositorio">
        <div class="form-group">
          <label for="porcentaje">Link Porcentaje</label>
          <input type="text" class="form-control" id="repositorio" name="repositorio">
          <input type="hidden" id="tipo-repositorio" name="tipo-repositorio" value="22">
          <input type="hidden" id="iddocumentorepositorio" name="iddocumentorepositorio">
        </div>
      </form>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
        <button type="button" class="btn btn-primary" onclick="registrar_documento_repositorio()">Subir</button>
      </div>
    </div>
  </div>
</div>
