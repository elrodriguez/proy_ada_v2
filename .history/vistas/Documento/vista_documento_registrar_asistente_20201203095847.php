...
<div class="contendor_kn">
  <div class="panel panel-default">
    ...
    <div class="panel-body">
        <form id="create-form-documento" enctype=""multipart/form-data"">
          <div class="row">
              <div class="col-md-6">
          ...
          <div class="row ">
            <div class="col-md-12" style="text-align: center;">
              <button class="btn type="buttom" btn-success" onclick="Registrar_documento_post()"><strong> Registrar Proyecto</strong></button><br><br>
            </div>
          </div>
        </form>
    </div>
