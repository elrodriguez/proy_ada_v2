<script type="text/javascript" src="_recursos/js/console_documento_coordinador_revisor_generar_resolucion.js"></script>
...
<iframe style="display: none;" id="iframe-word-descarga"></iframe>
<!-- INICIO MODAL -->
...
<div class="modal" tabindex="-1" id="modal-subir-anexos-resolucion">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Cargar Resolucion Firmada</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
      <form enctype="multipart/form-data" id="form-upload-file-anexos-resolucion">
      <div class="form-group">
          <label for="file-a1">Archivo pdf</label>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="registrar_documento_anexos_resolucion_subir()">Guardar uuuu</button>
      </div>
    </div>
  </div>
</div>
