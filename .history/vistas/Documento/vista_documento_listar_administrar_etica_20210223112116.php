<script type="text/javascript" src="_recursos/js/console_documento_coordinador_etica.js"></script>
...
<!-- INICIO MODAL -->
<script type="text/javascript">listar_documento_vista_etica("","1");</script>
<!--Fin Modal-->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
          <label for="file-a4v1">A4 V1</label>
          <div class="input-group">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-save_c" onclick="registrar_documento_anexos()">Guardar fff</button>
      </div>
    </div>
  </div>
</div>
