<script type="text/javascript" src="_recursos/js/console_documento_coordinador_revisor.js"></script>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
          <label for="file-a6">A6</label>
          <input type="file" class="form-control" id="file-a6" name="file-a6">
        </div>
      </form>
      </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="aprobaronservardocumento()">Save changes</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
