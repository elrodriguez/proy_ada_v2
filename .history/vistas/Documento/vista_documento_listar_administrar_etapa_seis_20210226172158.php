      ...
      <div class="modal-body">
        <div class="form-group">
          ...
          <select name="" id="">
            ...
            <option value="">Articulo no Publicado</option>
            <option value="">Articulo publicado</option>
            <option value="">tradicional</option>
            <option value="">tradicional</option>
          </select>
        </div>
        <div class="form-group">
          <label for="adicional1">Nombre de la revista</label>
          <input type="text" class="form-control" id="adicional1">
        </div>
        <div class="form-group">
          <label for="adicional2">Nombre de la revista</label>
