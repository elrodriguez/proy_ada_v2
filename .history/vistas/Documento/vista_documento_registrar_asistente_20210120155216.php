...
<script type="text/javascript">Listar_programa_academico();</script>
<!--Fin Modal-->
<!-- Modal -->
<div class="modal fade" id="myModalasesores" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              ...
              <select name="combo_asesor" id="combo_asesor" onchange="agregarDatosAsesor()">
