        ...
        <form method="POST" id="create-form-documento">
          <div class="form-group">
            ...
            <div class="col-md-6">
              ...
              <input type="text" class="form-control"  placeholder="Ingresar Número de Ticket ..." id="idnumero" name="idnumero"></input>
            </div>
            <div class="col-md-6">
              <label>Número de Ticket</label>
              <input type="text" class="form-control"  placeholder="Ingresar Número de Ticket ..." id="idnumero" name="idnumero"></input>
          ...
          <div class="form-group">
            ...
            <button class="btn btn-success" onclick="Registrar_documento_post()"><strong> Registrar Documento</strong></button><br><br>
            </div>
          </div>
        </form>
    </div>
               ...
               <div class="box-body">
                  <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs pull-right">
                      <li class="active"><a href="#tab_1-1" data-toggle="tab"><strong> ALUMNO</strong>  </a></li>
