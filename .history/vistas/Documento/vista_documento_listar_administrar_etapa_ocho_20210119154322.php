<script type="text/javascript" src="_recursos/js/console_documento_coordinador_etapa_ocho.js"></script>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Subir Anexo 13</h5>
