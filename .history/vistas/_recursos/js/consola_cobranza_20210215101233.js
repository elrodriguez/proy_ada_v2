		...
		success: function(resp){
			...
			if(valores.length>0){
				...
				for(var i = 0 ; i<valores.length; i++){
						...
						if(pagar){
							cadena += `<button onclick='cambiarestadoapagado("`+valores[i]['id']+`","1","1","`+valores[i]['mdp']+`","`+valores[i]['categoria']+`","`+valores[i]['tip']+`")'>pagado</button>`;
						}
		...
		success: function(resp){
			...
			if(valores.length>0){
				...
				for(var i = 0 ; i<valores.length; i++){
					...
					cadena += "<td style = 'vertical-align: middle;'>";
					if(pagar){
						cadena += `<button onclick='cambiarestadoapagado("`+valores[i]['id']+`","1","2","`+valores[i]['mdp']+`","`+valores[i]['categoria']+`","`+valores[i]['tip']+`")'>pagado</button>`;
					}
					cadena += "</td> ";
					cadena += "</tr>";
				}
		...
		success: function(resp){
			...
			if(valores.length>0){
				...
				for(var i = 0 ; i<valores.length; i++){
					...
					cadena += "<td style = 'vertical-align: middle;'>";
					if(pagar){
						cadena += `<button onclick='cambiarestadoapagado("`+valores[i]['id']+`","1","3","`+valores[i]['mdp']+`","`+valores[i]['categoria']+`","`+valores[i]['tip']+`")'>pagado</button>`;
					}
					cadena += "</td> ";
					cadena += "</tr>";
				}
