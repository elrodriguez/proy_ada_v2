		...
		success: function(resp){
			...
			if(valores.length>0){
				...
				for(var i = 0 ; i<valores.length; i++){
					...
					cadena += `<td><button class='btn btn-primary btn-sx' style='background-color:#fff;border-color:#fff' type="button"><i class="glyphicon glyphicon-edit" style='color:#000000;'></i></button></td>`;
