...
function exportarexcelpagardocente() {
	let desde = $('#txtfecha_desde').val();
	let hasta = $('#txtfecha_hasta').val();

	$('#frameexcel').attr('src','../controlador/cobranza/controlador_exportar_excel_pagar_docente.php?desde='+desde+'&hasta='+hasta)
