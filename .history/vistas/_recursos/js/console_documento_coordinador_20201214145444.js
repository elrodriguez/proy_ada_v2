				...
				for(var i = 0 ; i<valores.length; i++){
					...
					if(valores[i][13] =='2'){
						if (valores[i][5]=="RECHAZADO") {
							cadena += "<td style = 'text-align: center;width: 20px;word-wrap: break-word;'> <i class='glyphicon glyphicon-remove'></i> tt</td>";
						}else if (valores[i][5]=="PENDIENTE") {
							cadena += "<td style = 'text-align: center;width: 20px;word-wrap: break-word;'> <i class='glyphicon glyphicon-hourglass'></i> rr</td>";
						}else
						{
							cadena += "<td style = 'text-align: center;width: 20px;word-wrap: break-word;'> <i class='glyphicon glyphicon-ok'></i>t </td>";
						}
					}else{
