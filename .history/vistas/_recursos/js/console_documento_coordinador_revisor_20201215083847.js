			...
			if(valores.length>0){
				...
				for(var i = 0 ; i<valores.length; i++){
					...
					if(valores[i]['anexo_uno']){
						btn_ver = `<button type='button' class='btn btn-link' onclick='modalverturniting("`+valores[i][0]+`","`+valores[i]['anexo_uno']+`")' >A1</button>`;
					}
					if(valores[i]['anexo_seis']){
						btn_ver = `<button type='button' class='btn btn-link' onclick='modalverturniting("`+valores[i][0]+`","`+valores[i]['anexo_seis']+`")' >A1</button>`;
					}
