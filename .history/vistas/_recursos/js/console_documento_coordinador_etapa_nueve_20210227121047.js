		...
		success: function(resp){
			...
			if(valores.length>0){
				...
				for(var i = 0 ; i<valores.length; i++){
					...
					cadena += `<td><button name="`+valores[i][0]+`*`+valores[i]['constancia']+`" onclick="modalsubiranexosetapanueve(this,'26')" class='btn btn-primary btn-sx' style='background-color:#fff;border-color:#fff'><i class='fa fa-cloud-upload' style='color:orange;'></i></button></td>`;
