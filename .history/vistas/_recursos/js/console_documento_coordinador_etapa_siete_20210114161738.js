	...
	$.ajax({
		...
		success: function(resp){
			...
			if(valores.length>0){
				...
				cadena += "<th rowspan='2' style = 'vertical-align: middle;text-align: center;color: #fff;width: 20px;word-wrap: break-word;'>CARGAR anexo A10</th>";
...
function AbrirModalRevisorAgregar(control) {
	$.ajax({
		url:'../controlador/documento/controlador_documento_traeremitente_jurado_listar.php',
		type:'POST',
		data:{
			codigo:control
		}
