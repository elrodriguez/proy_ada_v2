	...
	$.ajax({
		...
		success: function(resp){
			...
			if(valores.length>0){
				...
				cadena += "<th style = 'text-align: center;width: 20px;word-wrap: break-word;'>TÍTULO</th>";
				...
				cadena += "<th style = 'text-align: center;width: 30px;word-wrap: break-word;'>ETAPA</th>";
				...
				for(var i = 0 ; i<valores.length; i++){
					...
					cadena += "<td style = 'text-align: center;width: 20px;word-wrap: break-word;'>9</td>";
