		...
		success: function(resp){
			...
			if(valores.length>0){
				...
				for(var i = 0 ; i<valores.length; i++){
					...
					cadena += `<td><button type='button' class='btn btn-link' onclick='modalveranexos("A7","`+valores[i][0]+`","`+valores[i]['anexo_uno']+`")' >A7</button></td>`;
					cadena += `<td><button type='button' class='btn btn-link' onclick='modalveranexos("Carta","`+valores[i][0]+`","`+valores[i]['anexo_uno']+`")' >Carta</button></td>`;
