...
function enviarcorreopordocumentorevisor(){
	...
	$.get( "../controlador/documento/controlador_enviar_correo_aprobado_observado.php?doc="+doc+'&correo='+correo, function( data ) {
...
function aprobaronservardocumento(codigo){
	...
	swal({
		...
		if (willDelete) {
			$.ajax({
				url:'../controlador/documento/controlador_enviar_correo_revisor_aprobado_observado.php',
				type:'POST',
				data:{
