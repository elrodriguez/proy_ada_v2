				...
				for(var i = 0 ; i<valores.length; i++){
					...
					if(valores[i]['num_proceso'] =='3'){
						if (valores[i][5]=="RECHAZADO") {
							cadena += "<i class='glyphicon glyphicon-remove' style='color:#000000;'></i>hhhh";
						}else if (valores[i][5]=="PENDIENTE") {
							cadena += `<i onclick='rechazarproceso("`+valores[i][0]+`")' class='glyphicon glyphicon-question-sign' style='color:#000000;'></i> hhh`;
						}else
						{
							cadena += `<i onclick='rechazarproceso("`+valores[i][0]+`")' class='glyphicon glyphicon-ok' style='color:#000000;'></i> hhhh `;
						}
					}else{
						cadena += "<i class='glyphicon glyphicon-ok' style='color:#000000;'></i> hhh";
					}
					cadena +="</td>";
