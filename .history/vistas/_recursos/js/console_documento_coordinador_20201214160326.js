		...
		success: function(resp){
			...
			if(valores.length>0){
				...
				for(var i = 0 ; i<valores.length; i++){
					...
					cadena += `<td style = 'text-align: center;' title='`+valores[i][5]+`' onclick='rechazarproceso("`+valores[i][0]+`")'>`;
					if(valores[i][13] =='2'){
						if (valores[i][5]=="RECHAZADO") {
							cadena += "<i class='glyphicon glyphicon-remove' style='color:#000000;'></i>";
						}else if (valores[i][5]=="PENDIENTE") {
							cadena += "<i class='glyphicon glyphicon-question-sign' style='color:#000000;'></i>";
						}else
						{
