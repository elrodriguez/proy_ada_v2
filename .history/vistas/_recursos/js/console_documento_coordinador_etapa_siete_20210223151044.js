		...
		success: function(resp){
			...
			if(valores.length>0){
				...
				for(var i = 0 ; i<valores.length; i++){
					...
					cadena += `<td><a href="#" class="username" data-type="text" data-pk="1" data-url="../controlador/documento/controlador_documento_registrar_turniting_paso_siete.php" data-title="Enter username">0</a></td>`;
