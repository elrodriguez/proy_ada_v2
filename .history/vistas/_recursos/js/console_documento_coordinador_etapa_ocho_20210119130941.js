		...
		success: function(resp){
			...
			if(valores.length>0){
				...
				for(var i = 0 ; i<valores.length; i++){
					...
					cadena += "&nbsp;</button> </td>";
					cadena += `<td><button class='btn btn-primary btn-sx' style='background-color:#fff;border-color:#fff' onclick='AbrirModalSubirArchivoAnexos(this)'><i class='fa  fa-folder-open' style='color:orange;'></i></button></td>`;
					cadena += `<td><input type="checkbox"></td>`;
					cadena += `<td><input type="checkbox"></td>`;
