			...
			if(valores.length>0){
				...
				for(var i = 0 ; i<valores.length; i++){
					...
					if(valores[i]['proyecto_etapa_tres']){
						btn_ver_pro += `/<button type='button' class='btn btn-link' onclick='modalveranexos("A6","`+valores[i][0]+`","`+valores[i]['anexo_seis']+`")' >A6</button>`;
					}
					if(valores[i]['carta_etapa_tres']){
						btn_ver_car += `/<button type='button' class='btn btn-link' onclick='modalveranexos("A6","`+valores[i][0]+`","`+valores[i]['anexo_seis']+`")' >A6</button>`;
					}
