		...
		success: function(resp){
			...
			if(valores.length>0){
				...
				for(var i = 0 ; i<valores.length; i++){
					...
					cadena += `<td><button type='button' class='btn btn-link' onclick='modalveranexos("`+valores[i][0]+`")' ><i class="glyphicon glyphicon-download-alt"></i></button></td>`;
...
function generar_resolucion_word(documento){
	$.get( "../controlador/documento/controlador_enviar_correo_revisor_aprobado_observado.php?doc="+documento, function( data ) {
		console.log(data)
	});
}