	...
	$.ajax({
		...
		success: function(resp){
			...
			if(valores.length>0){
				...
				cadena += "<thead  class=''>";
				cadena += "<tr >";
				cadena += "<th rowspan='2' style = 'text-align: center;color:#fff;width: 80px;word-wrap: break-word;'>ID</th>";
				cadena += "<th rowspan='2' style = 'text-align: center;color:#fff;width: 20px;word-wrap: break-word;'>TÍTULO</th>";
				cadena += "<th rowspan='2' style = 'text-align: center;color:#fff;width: 150px;word-wrap: break-word;'>FECHA RECEPCI&OacuteN</th>";
				...
				cadena += "<th rowspan='2' style = 'text-align: center;color:#fff;width: 150px;word-wrap: break-word;'>D&Iacute;AS RESTANTES</th>";
				cadena += "<th rowspan='2' style = 'text-align: center;color:#fff;width: 150px;word-wrap: break-word;'>ASESOR</th>";
				cadena += "<th rowspan='2' style = 'text-align: center;color:#fff;width: 150px;word-wrap: break-word;'>&Aacute;REA ASIGNADA</th>";
				cadena += "<th rowspan='2' style = 'text-align: center;color:#fff;width: 150px;word-wrap: break-word;'>REVISOR</th>";
				cadena += "<th rowspan='2' style = 'text-align: center;color:#fff;width: 120px;word-wrap: break-word;''>TIPO DOCUMENTO</th>";
				cadena += "<th rowspan='2' style = 'text-align: center;color:#fff;width: 30px;word-wrap: break-word;'>ALUMNO</th>";
				cadena += "<th rowspan='2' style = 'text-align: center;color:#fff;width: 20px;word-wrap: break-word;'>ARCHIVO</th>";
				cadena += "<th rowspan='2' style = 'text-align: center;color: #fff;width: 20px;word-wrap: break-word;'>INFORME TURNITING</th>";
				cadena += "<th rowspan='2' style = 'text-align: center;color: #fff;width: 20px;word-wrap: break-word;'>CARGAR anexo A6</th>";
				cadena += "<th rowspan='2' style = 'text-align: center;color:#fff;width: 120px;'></th>";
				cadena += "<th rowspan='2' style = 'text-align: center;color:#fff;width: 120px;'>Por Pagar</th>";
				cadena += "<th rowspan='2' style = 'text-align: center;color:#fff;width: 120px;'>Saltar Etica</th>";
				cadena += "<th rowspan='2' style = 'text-align: center;color:#fff;width: 20px;word-wrap: break-word;'>ESTADO</th>";
				cadena += "<th rowspan='2' style = 'text-align: center;color:#fff;width: 10px;word-wrap: break-word;''>ACCI&Oacute;N</th>";
				cadena += "</tr>";
				cadena += "<tr>";
				cadena += "<th style = 'text-align: center;color:#fff;width: 150px;word-wrap: break-word;'>INICIO</th>";
				...
				for(var i = 0 ; i<valores.length; i++){
					...
					if(valores[i]['archivo_etapa1_v3'] != '0'){
						cadena += "<button name='"+valores[i]['archivo_etapa1_v3']+"' class='btn btn-primary btn-sx' style='background-color:#fff;border-color:#fff' title='Ver documento Cargado' onclick='AbrirModalArchivo_documento(this)'><i class='fa  fa-folder-open' style='color:orange;'></i></button>";
					}else if(valores[i]['archivo_etapa1_v2'] != '0'){
						cadena += "<button name='"+valores[i]['archivo_etapa1_v2']+"' class='btn btn-primary btn-sx' style='background-color:#fff;border-color:#fff' title='Ver documento Cargado' onclick='AbrirModalArchivo_documento(this)'><i class='fa  fa-folder-open' style='color:orange;'></i></button>";
					}else{
						cadena += "<button name='"+valores[i]['doc_documento']+"' class='btn btn-primary btn-sx' style='background-color:#fff;border-color:#fff' title='Ver documento Cargado' onclick='AbrirModalArchivo_documento(this)'><i class='fa  fa-folder-open' style='color:orange;'></i></button>";
					}
					cadena +="</td>";
					cadena += `<td style = 'text-align: center;width: 20px;word-wrap: break-word;'><button type='button' class='btn btn-link' onclick='modalverturnitingcoordinador("`+valores[i]['porcentaje']+`","`+valores[i][0]+`","`+valores[i]['archivo_turniting']+`")' >Ver</button></td>`;
					
					let btn_ver='';
					//if(valores[i]['anexo_uno']){
					//	btn_ver += `<button type='button' class='btn btn-link' onclick='modalveranexos("A1","`+valores[i][0]+`","`+valores[i]['anexo_uno']+`")' >A1</button>`;
					//}
					//if(valores[i]['anexo_seis']){
					//	btn_ver += `/<button type='button' class='btn btn-link' onclick='modalveranexos("A6","`+valores[i][0]+`","`+valores[i]['anexo_seis']+`")' >A6</button>`;
					//}
					cadena += "<td><button name='"+valores[i][0]+"*"+valores[i]['anexo_seis']+"*"+valores[i]['anexo_seis_2']+"*"+valores[i]['anexo_seis_3']+"' class='btn btn-primary' onclick='AbrirModalSubirArchivoAnexos(this)'><i class='fa fa-cloud-upload'></i></button></td>";
					...
					if(valores[i]['num_proceso'] =='3'){
						...
						//}else if (valores[i][5]=="PENDIENTE") {
							cadena += `<button onclick='rechazarproceso("`+valores[i][0]+`","PENDIENTE","4")'>Aceptar</button>
							<button onclick='rechazarproceso("`+valores[i][0]+`","RECHAZADO","3")'>Rechazar</button>`;
						//}else{
							//cadena += `<button onclick='rechazarproceso("`+valores[i][0]+`","RECHAZADO")'>Rechazar</button>`;
						//}
					}else{
...
function registrar_documento_anexos(){
	$.ajax({
	  type : 'POST',
	  url:'../controlador/documento/controlador_registrar_documento_coordinador_anexos.php',
...
function modalveranexos(anexo,title,url){
	...
	var iframehtml = `<iframe id="iframemodalanexo" src="../controlador/documento/`+url+`" width="100%" height="500" frameborder="0" scrolling="no"></iframe>`;
...
function pagarrevisor(codigo){
	...
	swal({
		...
		if (willDelete) {
			$.ajax({
				url:'../controlador/documento/controlador_documento_coordinador_pagar_revisor.php',
				type:'POST',
				data:{
					codigo:codigo,estado:estado
				}
