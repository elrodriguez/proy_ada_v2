			...
			if(valores.length>0){
				...
				for(var i = 0 ; i<valores.length; i++){
					...
					cadena += `<td style = 'text-align: center;width: 100px;word-wrap: break-word;'>
									<div class="progress">
										<div class="progress-bar" role="progressbar" aria-valuenow="`+porcentaje.toFixed(2)+`" aria-valuemin="0" aria-valuemax="100" style="min-width: 2em;width: `+porcentaje.toFixed(0)+`%;">
