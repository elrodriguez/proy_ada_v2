			...
			if(valores.length>0){
				...
				for(var i = 0 ; i<valores.length; i++){
					...
					cadena += `<td style = 'text-align: center;width: 150px;word-wrap: break-word;'>
						<input type="date" id="date-`+valores[i][0]+`" onchange="registrarfechas(event,'1','`+valores[i][0]+`')" value="">
					</td>`;
					cadena += `<td style = 'text-align: center;width: 150px;word-wrap: break-word;'>
						<input type="date" id="date-`+valores[i][0]+`" onchange="registrarfechas(event,'2','`+valores[i][0]+`')" value="">
					</td>`;
