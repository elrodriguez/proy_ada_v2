		...
		success: function(resp){
			...
			if(valores.length>0){
				...
				for(var i = 0 ; i<valores.length; i++){
					...
					cadena += "&nbsp;</button> </td>";
					cadena += `<td><a href="../`+valores[i]['archivo_uno']+`" class='btn btn-primary btn-sx' style='background-color:#fff;border-color:#fff'><i class='glyphicon glyphicon-folder-open' style='color:orange;'></i></button></td>`;
