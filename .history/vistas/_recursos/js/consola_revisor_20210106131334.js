function listar_personal_vista(valor,pagina){
	...
	$.ajax({
		url:'../controlador/revisor/controlador_revisor_listado.php',
		type: 'POST',
		...
		success: function(resp){
			...
			if(valores.length>0){
				...
				cadena += "<th style = 'text-align: center;color:#fff'>PUESTO</th>";
				cadena += "<th style = 'text-align: center;color:#fff'>USUARIO</th>";
