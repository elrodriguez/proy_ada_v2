...
function agregarDatosAsesor(){
	...
	inputs += `<div id="div-asesor-agregados`+datos_split[0]+`">
				<div class="col-md-5">
					...
					<input type="text" value="`+datos_split[0]+`" id="txtasesor`+datos_split[0]+`" name="idasesor[]" readonly style="color: rgb(25,25,51); background-color: rgb(255,255,255);solid 5px;color:#9B0000; text-align:center;font-weight: bold;" readonly class="form-control">
				</div>
				<div class="col-md-5">
