		...
		success: function(resp){
			...
			if(valores.length>0){
				...
				for(var i = 0 ; i<valores.length; i++){
					...
					cadena += `<td><button type='button' class='btn btn-link' onclick='modalveranexos("A1","`+valores[i][0]+`","`+valores[i]['anexo_uno']+`")' >A1</button><button type='button' class='btn btn-link' onclick='modalveranexos("A4","`+valores[i][0]+`","`+valores[i]['anexo_seis']+`")' >A4</button></td>`;
