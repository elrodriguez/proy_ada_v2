		...
		success: function(resp){
			...
			if(valores.length>0){
				...
				for(var i = 0 ; i<valores.length; i++){
					...
					cadena += "<td>"+valores[i]['moda']+"</td>";
					cadena += "<td>"+valores[i]['por_pagar_fecha']+"</td>";
					cadena += "<td>";
					cadena += `<button onclick='rechazarproceso("`+valores[i]['id']+`","1","1")'>pagado</button>`;
					cadena += "</td> ";
					cadena += "</tr>";
				}
				cadena += "</tbody>";
		...
		success: function(resp){
			...
			if(valores.length>0){
				...
				for(var i = 0 ; i<valores.length; i++){
					...
					cadena += "<td>"+valores[i]['por_pagar_fecha']+"</td>";
					cadena += "<td>";
					cadena += `<button onclick='rechazarproceso("`+valores[i]['id']+`","1","2")'>pagado</button>`;
					cadena += "</td> ";
					cadena += "</tr>";
				}
				cadena += "</tbody>";
		...
		success: function(resp){
			...
			if(valores.length>0){
				...
				for(var i = 0 ; i<valores.length; i++){
					...
					cadena += "<td>"+valores[i]['por_pagar_fecha']+"</td>";
					cadena += "<td>";
					cadena += `<button onclick='rechazarproceso("`+valores[i]['id']+`","1","3")'>pagado</button>`;
					cadena += "</td> ";
					cadena += "</tr>";
				}
				cadena += "</tbody>";
