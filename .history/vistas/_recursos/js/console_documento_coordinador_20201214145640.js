				...
				for(var i = 0 ; i<valores.length; i++){
					...
					if(valores[i][13] =='2'){
						if (valores[i][5]=="RECHAZADO") {
							cadena += "<td style = 'text-align: center;width: 20px;'> <i class='glyphicon glyphicon-remove' style='color:#000000;'></i></td>";
						}else if (valores[i][5]=="PENDIENTE") {
							cadena += "<td style = 'text-align: center;width: 20px;'> <i class='glyphicon glyphicon-hourglass' style='color:#000000;'></i></td>";
						}else
						{
							cadena += "<td style = 'text-align: center;width: 20px;'> <i class='glyphicon glyphicon-ok' style='color:#000000;'></i></td>";
						}
					}else{
						cadena += "<td style = 'text-align: center;width: 20px;'> <span class='glyphicon glyphicon-ok' style='color:#000000;'></span> </td>";
					}
