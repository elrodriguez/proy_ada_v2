				...
				for(var i = 0 ; i<valores.length; i++){
					...
					if(valores[i]['num_proceso'] =='4'){
						if (valores[i][5]=="RECHAZADO") {
							...
							cadena += `<i onclick='rechazarproceso("`+valores[i][0]+`")' class='glyphicon glyphicon-question-sign' style='color:#000000;'></i>`;
						}else
						{
							cadena += `<i onclick='rechazarproceso("`+valores[i][0]+`")' class='glyphicon glyphicon-ok' style='color:#000000;'></i>`;
						}
					}else{
