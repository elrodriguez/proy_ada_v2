	...
	$.ajax({
		...
		success: function(resp){
			...
			if(valores.length>0){
				...
				cadena += "<th rowspan='2' style = 'vertical-align: middle;text-align: center;color:#fff;width: 20px;word-wrap: break-word;'>ARCHIVO</th>";
				cadena += "<th rowspan='2' style = 'vertical-align: middle;text-align: center;color: #fff;width: 20px;word-wrap: break-word;'>INFORME TURNITING</th>";
				...
				cadena += "<th rowspan='2' style = 'vertical-align: middle;text-align: center;color:#fff;width: 120px;'>Saltar Etica</th>";
				...
				cadena += "<th style = 'text-align: center;color:#fff;width: 150px;word-wrap: break-word;'>A7</th>";
				...
				for(var i = 0 ; i<valores.length; i++){
					...
					//}
					cadena += "<td><button name='bb"+valores[i][0]+"*"+valores[i]['anexo_seis']+"*"+valores[i]['anexo_seis_2']+"*"+valores[i]['anexo_seis_3']+"'  class='btn btn-primary btn-sx' style='background-color:#fff;border-color:#fff' onclick='AbrirModalSubirArchivoAnexos(this)'><i class='fa  fa-folder-open' style='color:orange;'></i></button></td>";
					cadena += "<td><button name='by"+valores[i][0]+"*"+valores[i]['anexo_seis']+"*"+valores[i]['anexo_seis_2']+"*"+valores[i]['anexo_seis_3']+"' class='btn btn-primary' onclick='AbrirModalSubirArchivoAnexos(this)'><i class='fa fa-cloud-upload'></i></button></td>";
