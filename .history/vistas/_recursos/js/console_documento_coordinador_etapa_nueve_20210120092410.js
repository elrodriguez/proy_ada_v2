	...
	$.ajax({
		...
		success: function(resp){
			...
			if(valores.length>0){
				...
				cadena += "<th colspan='4' rowspan='2' style = 'vertical-align: middle;text-align: center;color:#fff;width: 120px;'>Documentos</th>";
				...
				for(var i = 0 ; i<valores.length; i++){
					...
					cadena += "&nbsp;</button> </td>";
					cadena += `<td><a target="blank" href="../`+valores[i]['archivo_uno']+`" class='btn btn-primary btn-sx' style='background-color:#fff;border-color:#fff'><i class='glyphicon glyphicon-folder-open' style='color:orange;'></i></button></td>`;
					cadena += `<td><a href="../`+valores[i]['archivo_dos']+`" class='btn btn-primary btn-sx' style='background-color:#fff;border-color:#fff'><i class='glyphicon glyphicon-folder-open' style='color:orange;'></i></button></td>`;
					cadena += `<td><a href="../`+valores[i]['archivo_tres']+`" class='btn btn-primary btn-sx' style='background-color:#fff;border-color:#fff'><i class='glyphicon glyphicon-folder-open' style='color:orange;'></i></button></td>`;
					cadena += `<td><a href="../`+valores[i]['archivo_cuatro']+`" class='btn btn-primary btn-sx' style='background-color:#fff;border-color:#fff'><i class='glyphicon glyphicon-folder-open' style='color:orange;'></i></button></td>`;
