...
function AbrirModalEditarCiudadano(control){
	...
	$('#modal_carrera').val(datos_split[14]);
	$('#txtcontrasenia').val(datos_split[14]);
}
function Editar_ciudadano(){
	...
	var carrera     = $("#modal_carrera").val();
	var clave     = $("#txtcontrasenia").val();
