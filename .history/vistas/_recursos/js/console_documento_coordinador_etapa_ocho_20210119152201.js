			...
			if(valores.length>0){
				...
				for(var i = 0 ; i<valores.length; i++){
					...
					if(valores[i]['estado_paso_tres']=="APROBADO"){
						btn_pagar = `<button class='btn btn-danger' onclick='rechazarproceso("`+valores[i][0]+`","PENDIENTE","7")'><i class='glyphicon glyphicon-repeat' styel="transform:rotate(90deg);"></i></button>`;
					}else{
						btn_pagar = '';
					}
