		...
		success: function(resp){
			...
			if(valores.length>0){
				...
				for(var i = 0 ; i<valores.length; i++){
					...
					cadena += `<td><button type='button' class='btn btn-link' onclick='modalveranexos("`+valores[i][0]+`")' ><i class="glyphicon glyphicon-download-alt" style="background-color:#fff;"></i></button></td>`;
