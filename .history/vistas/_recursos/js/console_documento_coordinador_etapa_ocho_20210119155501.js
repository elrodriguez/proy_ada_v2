		...
		success: function(resp){
			...
			if(valores.length>0){
				...
				for(var i = 0 ; i<valores.length; i++){
					...
					cadena += `<td><button name="`+valores[i][0]+`*`+valores[i]['anexo_dies_dos']+`" onclick="modalsubiranexosetapaocho(this,'17')" class='btn btn-primary btn-sx' style='background-color:#fff;border-color:#fff'><i class='fa fa-cloud-upload' style='color:orange;'></i></button></td>`;
					cadena += `<td><button name="`+valores[i][0]+`*`+valores[i]['anexo_dies_dos']+`" onclick="modalsubiranexosetapaocho(this,'18')" class='btn btn-primary btn-sx' style='background-color:#fff;border-color:#fff'><i class='fa fa-cloud-upload' style='color:orange;'></i></button></td>`;
					cadena += `<td><button name="`+valores[i][0]+`*`+valores[i]['anexo_dies_dos']+`" onclick="modalsubiranexosetapaocho(this,'19')" class='btn btn-primary btn-sx' style='background-color:#fff;border-color:#fff'><i class='fa fa-cloud-upload' style='color:orange;'></i></button></td>`;
					cadena += `<td><button name="`+valores[i][0]+`*`+valores[i]['anexo_dies_dos']+`" onclick="modalsubiranexosetapaocho(this,'20')" class='btn btn-primary btn-sx' style='background-color:#fff;border-color:#fff'><i class='fa fa-cloud-upload' style='color:orange;'></i></button></td>`;
