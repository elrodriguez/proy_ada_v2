		...
		success: function(resp){
			...
			if(valores.length>0){
				...
				for(var i = 0 ; i<valores.length; i++){
					...
					let btn_ver='';
					if(valores[i]['etica_anexo_uno']){
						btn_ver += `<button type='button' class='btn btn-link' onclick='modalveranexos("A1","`+valores[i][0]+`","`+valores[i]['etica_anexo_uno']+`")' >A1</button>`;
					}
					if(valores[i]['etica_anexo_cuatro']){
						btn_ver += `/<button type='button' class='btn btn-link' onclick='modalveranexos("A4","`+valores[i][0]+`","`+valores[i]['etica_anexo_cuatro']+`")' >A4</button>`;
					}
					cadena += "<td><button name='"+valores[i][0]+"*"+valores[i][1]+"*"+valores[i][2]+"*"+valores[i][3]+"*"+valores[i][4]+"*"+valores[i][5]+"*"+valores[i][6]+"*"+valores[i][7]+"*"+valores[i][8]+"*"+valores[i][9]+"*"+valores[i][10]+"*"+valores[i][11]+"*"+valores[i][12]+"*"+valores[i][13]+"*"+valores[i][14]+"' class='btn btn-primary' onclick='AbrirModalSubirArchivoAnexos(this)'><i class='fa fa-cloud-upload'></i></button>"+btn_ver+"</td>";
