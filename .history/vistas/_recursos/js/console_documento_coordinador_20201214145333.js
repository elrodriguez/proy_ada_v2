				...
				for(var i = 0 ; i<valores.length; i++){
					...
					if(valores[i][13] =='2'){
						if (valores[i][5]=="RECHAZADO") {
							cadena += "<td style = 'text-align: center;width: 20px;word-wrap: break-word;'> <span class='glyphicon glyphicon-remove'></span> </td>";
						}else if (valores[i][5]=="PENDIENTE") {
							cadena += "<td style = 'text-align: center;width: 20px;word-wrap: break-word;'> <span class='glyphicon glyphicon-hourglass'></span> </td>";
						}else
						{
							cadena += "<td style = 'text-align: center;width: 20px;word-wrap: break-word;'> <span class='glyphicon glyphicon-ok'></span> </td>";
						}
					}else{
						cadena += "<td style = 'text-align: center;width: 20px;word-wrap: break-word;'> <span class='glyphicon glyphicon-ok' style='color:White;'></span> </td>";
					}
