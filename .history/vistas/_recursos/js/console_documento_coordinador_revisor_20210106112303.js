				...
				for(var i = 0 ; i<valores.length; i++){
					...
					if(valores[i]['num_proceso'] =='3'){
						if (valores[i][5]=="RECHAZADO") {
							...
							cadena += `<i onclick='rechazarproceso("`+valores[i][0]+`","ACEPTADO")' class='glyphicon glyphicon-question-sign' style='color:#000000;'></i>
										<i onclick='rechazarproceso("`+valores[i][0]+`","RECHAZADO")' class='glyphicon glyphicon-ok' style='color:#000000;'></i>`;
						}else{
							cadena += `<i onclick='rechazarproceso("`+valores[i][0]+`","RECHAZADO")' class='glyphicon glyphicon-ok' style='color:#000000;'></i>`;
						}
					}else{
