		...
		success: function(resp){
			...
			if(valores.length>0){
				...
				for(var i = 0 ; i<valores.length; i++){
					...
					cadena += "<td><button name='"+valores[i][0]+"*"+valores[i]['anexo_seis']+"*"+valores[i]['anexo_seis_2']+"*"+valores[i]['anexo_seis_3']+"*r2' class='btn btn-turning' onclick='AbrirModalSubirArchivoAnexos(this)'><i class='fa fa-cloud-upload fa-2x'></i></button></td>";
					cadena += "<td><button name='"+valores[i][0]+"*"+valores[i]['anexo_seis']+"*"+valores[i]['anexo_seis_2']+"*"+valores[i]['anexo_seis_3']+"*r3' class='btn btn-turning' onclick='AbrirModalSubirArchivoAnexos(this)'><i class='fa fa-cloud-upload fa-2x'></i></button></td>";
					////subir anexo 6 end
