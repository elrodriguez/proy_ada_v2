...
<head>
  ...
  <script src="_recursos/input-file/js/bootstrap-uploader/file-upload.js"></script>
   ...
   <link rel="stylesheet" href="_recursos/css/mystyle.css">
   <link rel="stylesheet" href="public/bootstrap3-editable/bootstrap3-editable/css/bootstrap-editable.css">
</head>
<body>
          ...
          <nav ui-nav class="navi">
            <ul class="nav">
              <li class="hidden-folded padder m-t m-b-sm text-muted text-xs">
                <span translate="aside.nav.HEADER" style="color: #fff; font-weight:bold">PANEL ADMINISTRATIVO</span>
              </li>
              <li>
                <a href class="auto">
            ...
            ?>
              ...
              <li>
                <a href class="auto">
                  ...
                  <i class="glyphicon glyphicon-user icon text-info-lter"></i>
                  <span class="font-bold" translate="aside.nav.Mantenimiento">DOCENTE</span>
                </a>
                <ul class="nav nav-sub dk">
                  <li ui-sref-active="active" onclick="cargar_contenido('main-content','Asesor/vista_listar_asesor.php');">
                    <a ui-sref="app.dashboard-v2">
                    <span>Listar docentes</span>
                    </a>
                  </li>
                  <li ui-sref-active="active">
                    <a ui-sref="app.dashboard-v1" onclick="cargar_contenido('main-content','Asesor/vista_registrar_asesor.php');">
              ...
              <li>
                <a href class="auto">
                  ...
                  <span class="font-bold" translate="aside.nav.Mantenimiento">ALUMNOS</span>
                </a>
                <ul class="nav nav-sub dk">
...
<!-- __________________________________Segundo Usuario FRANCIS -->
              <?php if ($_SESSION['usu']=="ASISTENTE") {
              ?>
              <li ui-sref-active="active">
                <a ui-sref="app.mail.list">
                  <b class="badge bg-info pull-right">D</b>
                  <i class="fa fa-file-text icon text-info-lter"></i>
                  <span class="font-bold" translate="aside.nav.Venta">PROYECTO TESIS</span>
                </a>
               <ul class="nav nav-sub dk">
                  <li ui-sref-active="active">
                    <a ui-sref="app.dashboard-v2 "onclick="cargar_contenido('main-content','Documento/vista_documento_registrar_asistente.php')">
                    <span>Registro de proyecto Tesis</span>
                    </a>
                  </li>
                  <li ui-sref-active="active">
                    <a ui-sref="app.mail.list" onclick="cargar_contenido('main-content','Documento/vista_documento_listar_asistente.php')">
            ...
            <?php }
            ?>
<!-- __________________________TERCER USUARIO_JOSE_______________________ -->
            <?php if ($_SESSION['usu']=="COORDINADOR") {
            ?>
            <li ui-sref-active="active">
              <a ui-sref="app.mail.list">
                <b class="badge bg-info pull-right">D</b>
             ...
             <ul class="nav nav-sub dk">
                ...
                <!--li ui-sref-active="active">
                    <a ui-sref="app.dashboard-v1"onclick="cargar_contenido('main-content','Verificar_documento/vista_verificardocumento_listar_coordinador.php');">
                ...
                <li ui-sref-active="active">
                    <a ui-sref="app.administarion"onclick="cargar_contenido('main-content','Documento/vista_documento_listar_administrar_etapa_seis.php');">
                    <span>Asignar Jurados</span>
                  </a>
                </li>
                <li ui-sref-active="active">
                    <a ui-sref="app.administarion"onclick="cargar_contenido('main-content','Documento/vista_documento_listar_administrar_etapa_siete.php');">
                    <span>Administrar Jurado</span>
                  </a>
                </li>
                <li ui-sref-active="active">
                    <a ui-sref="app.administarion"onclick="cargar_contenido('main-content','Documento/vista_documento_listar_administrar_etapa_ocho.php');">
          ...
          <?php }
          ?>
<!-- _________________________CUARTO USUARIO________________________ -->
          <?php if ($_SESSION['usu']=="REVISOR") {
          ?>
          <li ui-sref-active="active">
            <a ui-sref="app.mail.list">
              <b class="badge bg-info pull-right">D</b>
           ...
           <ul class="nav nav-sub dk">
              <li ui-sref-active="active">
                <a ui-sref="app.mail.list" onclick="cargar_contenido('main-content','Documento/vista_documento_listar_administrar_etica.php')">
                <span>Comité de Ética</span>
                </a>
              </li>
              <li ui-sref-active="active">
                <a ui-sref="app.dashboard-v2 "onclick="cargar_contenido('main-content','Documento/vista_documento_listar_administrar_etapa_nueve.php')">
          ...
          <!-- ___________________________QUINTO USUARIO__________________ -->

          <?php if ($_SESSION['usu']=="COBRANZA") {
          ?>
          <li ui-sref-active="active">
            <a ui-sref="app.mail.list">
              <b class="badge bg-info pull-right">D</b>
           ...
           <ul class="nav nav-sub dk">
              <li ui-sref-active="active">
                <a ui-sref="app.mail.list" onclick="cargar_contenido('main-content','cobranza/vista_documento_listar.php')">
                <span>Listar Documento</span>
                </a>
              </li>
              <li ui-sref-active="active">
                <a ui-sref="app.mail.list" onclick="cargar_contenido('main-content','cobranza/vista_asesor_por_pagar_listado.php')">
                <span>Listar Asesores por pagar</span>
                </a>
              </li>
              <li ui-sref-active="active">
                <a ui-sref="app.mail.list" onclick="cargar_contenido('main-content','cobranza/vista_revisores_por_pagar_listado.php')">
                <span>Listar Revisores por pagar</span>
                </a>
              </li>
              <li ui-sref-active="active">
                <a ui-sref="app.mail.list" onclick="cargar_contenido('main-content','cobranza/vista_jurado_por_pagar_listado.php')">
                <span>Listar Jurados por pagar</span>
                </a>
              </li>
              <li ui-sref-active="active">
                <a ui-sref="app.mail.list" onclick="cargar_contenido('main-content','cobranza/vista_reporte_general.php')">
        ...
        <div class="contendor_kn">
          <div class="panel panel-default">
            <div class="panel-body">
              ...
              <img style="text-align: center;" align="center" src="ucsur-fonfo.png">
    ...
    <div class="app-footer wrapper b-t bg-light">
      <span class="pull-right">V.1.0.1 <a href="#app" class="m-l-sm text-muted"><i class="fa fa-long-arrow-up"></i></a></span>
      &copy; 2020 Copyright.
    </div>
    <!-- / footer -->
  </div>
