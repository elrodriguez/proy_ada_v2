<?php
	class Modelo_personal
	{
		...
		function editar_docente($nombre,$apePat,$apeMat,$telefo,$movil,$direcc,$fecnac,$dni,$email,$genero,$estado,$tipos){
			$sql = "call PA_EDITARPERSONALTODOS('$nombre','$apePat','$apeMat','$telefo','$movil','$direcc','$fecnac','$dni','$email','$genero','$estado','$tipos')";
			if ($resultado = $this->conexion->conexion->query($sql)){
				return 1;
			}
			else{
